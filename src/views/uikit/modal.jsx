        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                <code>&lt;Modal/&gt;</code> in combination with other components
                to show or hide your Modal. The <code> &lt;Modal/&gt;</code>{" "}
                Component comes with a few convenient "sub components":
                <code> &lt;Modal.Header/&gt;</code>,{" "}
                <code> &lt;Modal.Title/&gt;</code>,{" "}
                <code> &lt;Modal.Body/&gt;</code>, and{" "}
                <code> &lt;Modal.Footer/&gt;</code>, which you can use to build
                the Modal content.
              </p>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary mt-xxl-0 mt-2" onClick={handleShow5}>
                Small modal
              </Button>{" "}
        ...
        <Col sm="12" lg="6">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Button variant="primary mb-2 mb-xxl-0" onClick={handleShow7}>
