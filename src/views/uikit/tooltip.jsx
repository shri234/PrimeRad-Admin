          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                the Tooltip component. Or pass a Tooltip element to{" "}
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                the overlay from a wrapper<code> &lt;div&gt; </code>or{" "}
                <code> &lt;span&gt; </code>and override the pointer-events on
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on top</Tooltip>}
              >
                <Button className="bg-soft-primary mt-3 text-primary border-0">
                  Tooltip on top
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on right</Tooltip>}
              >
                <Button className="bg-soft-success mt-3 text-sucess border-0">
                  Tooltip on right
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on bottom</Tooltip>}
              >
                <Button className="bg-soft-danger mt-3 text-danger border-0">
                  Tooltip on bottom
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on left</Tooltip>}
              >
                <Button className="bg-soft-info mt-3 text-info border-0">
                  Tooltip on left
                </Button>
              </OverlayTrigger>{" "}
            </Card.Body>
