      ...
      <Row>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                slightly more opinionated heading style. Keep in mind these
                headings are not responsive by default, but it’s possible to
                enable{" "}
        ...
        <Col sm={12} lg={6}>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                Remove a list’s bullets and apply some light <code>margin</code>{" "}
