          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                Background utilities do not set color, so in some cases you’ll
                want to use .text-* utilities.{" "}
                <strong>
              ...
              <Row className=" mt-4">
                ...
                <div className="col-lg-2 col-md-6 text-center">
                  <p className="bg-gray pt-5 pb-5 text-center rounded"></p>
                  <h6>Secondary</h6>
                </div>
                <div className="col-lg-2 col-md-6 text-center">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Row className="mt-4">
                ...
                <div className="col-lg-2 col-md-6 text-center mt-4">
                  <p className="bg-soft-gray pt-5 pb-5 text-center rounded font-size-18">
                    Gray
                  </p>
                </div>
              </Row>
        ...
        <Col lg={6}>
          <Card>
            ...
            <Card.Body>
              ...
              <p className="bg-soft-dark ps-3 pe-3 pt-2 pb-2 rounded">
                Dark link
              </p>
              <p className="bg-soft-gray ps-3 pe-3 pt-2 pb-2 rounded mb-0">
                Gray link
              </p>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <p>
                <Link
                  to="#"
                  className="dark ps-3 pe-3 pt-2 pb-2 rounded d-inline-block"
                >
                  Dark link
                </Link>
              </p>
              <p>
                <Link
                  to="#"
                  className="bg-soft-gray ps-3 pe-3 pt-2 pb-2 rounded d-inline-block"
                >
                  Gray link
                </Link>
              </p>
