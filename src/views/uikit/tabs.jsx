          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                <code> .flex-column</code> class, or your own css. You can even
                use the responsive versions to stack in some viewports but not
                others (e.g. <code> .flex-sm-column </code>).
              </p>
              <Row>
                <Tab.Container defaultActiveKey="first">
                  <Col sm="3">
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                your nav to extend the full available width. To proportionately
                fill the space use fill. Notice that the nav is the entire width
                but each nav item is a different size. the full available width.
                To proportionately fill the space use <code> fill </code>.
