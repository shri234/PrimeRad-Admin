...
const Pricing = memo(() => {
  ...
  const pricingLists = t("pricingLists", { returnObjects: true });
  return (
    <Fragment>
      <Row>
        <Col md="12">
              ...
              <Card className=" mb-4">
                ...
                <Card.Body>
                  <ul className="list-unstyled mb-0 p-0">
                    <li>
                      <p>{t("pricing.users_included")}</p>
                    </li>
                    <li>
                      <p>{t("pricing.gb_of_storage")}</p>
                    </li>
                    <li>
            ...
            <Col sm="12">
              <Card>
                <Card.Header className=" pb-3">
                  <h3 className="block-title">{t("pricing.premium")}</h3>
                </Card.Header>
                        ...
                        <tr>
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="h4">{t("pricing.free")}</div>
                              <div className="h2">
                                <b>$0</b>
                          ...
                          >
                            ...
                            >
                              <div className="h4">{t("pricing.pro")}</div>
                              <div className="h2">
                                $15<small> {t("pricing.month")}</small>
                              </div>
                              <small className="type-1">
                                {t("pricing.recommended")}
                              </small>
                          ...
                          >
                            ...
                            >
                              <span className="h4">{t("pricing.premium")}</span>
                              <div className="h2">
                                $49<small>{t("pricing.month")}</small>
                              </div>
                              <small className="type-1">
                                {t("pricing.recommended")}
                              </small>
                      ...
                      <tbody>
                        {pricingLists.map((item) => (
                          <tr key={item.title}>
                            ...
                            <td
                              className={` child-cell text-center ${
                                pricing === "Basic" ? "active" : ""
                              }`}
                            >
                              {item.icon}
          ...
          <Row className="row-cols-1 row-cols-md-2 row-cols-lg-3 mb-3 text-center">
            ...
            <Col>
              <Card className="mb-4">
                <Card.Header className="bg-soft-primary p-4">
                  <Card.Title className="h3 pricing-card-title mb-3" as="h5">
          ...
          <Card>
            <div className="justify-content-center justify-content-sm-between d-flex card-header border-bottom ">
              <h4 className="d-inline-block">{t("pricing.choose_plan")}</h4>
