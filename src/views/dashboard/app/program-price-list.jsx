...
const programPrices = [
  {
    ...
    price: "$100",
    status: "Active",
    created: "01-01-2024 09:00 AM",
  },
  {
    name: "Advanced Program",
    price: "$250",
    status: "Active",
    created: "05-01-2024 10:30 AM",
  },
  {
    name: "Premium Program",
    price: "$500",
    status: "Inactive",
    created: "10-01-2024 11:45 AM",
  },
];
...
const ProgramPriceList = () => (
  <Fragment>
    <Row>
      <Col sm="12">
        <Card>
          <Card.Header className="bg-light">
            <h4 className="mb-0">Program Price List</h4>
          </Card.Header>
          <Card.Body>
            <div className="mb-3">
              <Link
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th style={headerStyle}>Program Name</th>
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
              <span>
                Showing 1 to {programPrices.length} of {programPrices.length}{" "}
                entries
              </span>
              <nav>
...
export default ProgramPriceList;
