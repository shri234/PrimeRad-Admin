...
const notifications = [
  {
    ...
    status: "Unread",
    created: "01-11-2024 09:00 AM",
  },
  {
    title: "New Feature",
    message: "New dashboard released.",
    status: "Read",
    created: "05-11-2024 10:30 AM",
  },
  {
    title: "Maintenance",
    message: "Scheduled maintenance on Sunday.",
    status: "Unread",
    created: "10-11-2024 11:45 AM",
  },
];
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
              <span>
                Showing 1 to {notifications.length} of {notifications.length}{" "}
                entries
              </span>
              <nav>
