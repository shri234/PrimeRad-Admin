...
const sponsorMembers = [
  {
    ...
    sponsor: "MedTech Inc.",
    status: "Active",
    created: "01-10-2024 09:00 AM",
  },
  {
    name: "Bob White",
    sponsor: "HealthPlus",
    status: "Active",
    created: "05-10-2024 10:30 AM",
  },
  {
    name: "Charlie Black",
    sponsor: "BioCare",
    status: "Inactive",
    created: "10-10-2024 11:45 AM",
  },
];
...
const SponsorMembersList = () => (
  <Fragment>
    <Row>
      <Col sm="12">
        <Card>
          <Card.Header className="bg-light">
            <h4 className="mb-0">Sponsor Members List</h4>
          </Card.Header>
          <Card.Body>
            <div className="mb-3">
              <Link
                ...
                <tbody>
                  {sponsorMembers.map((item, idx) => (
                    ...
                    >
                      ...
                      <td style={cellStyle}>{item.sponsor}</td>
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
              <span>
                Showing 1 to {sponsorMembers.length} of {sponsorMembers.length}{" "}
                entries
              </span>
              <nav>
...
export default SponsorMembersList;
