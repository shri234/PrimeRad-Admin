...
const sponsors = [
  {
    ...
    type: "Platinum",
    status: "Active",
    created: "01-09-2024 09:00 AM",
  },
  {
    name: "HealthPlus",
    type: "Gold",
    status: "Active",
    created: "05-09-2024 10:30 AM",
  },
  {
    name: "BioCare",
    type: "Silver",
    status: "Inactive",
    created: "10-09-2024 11:45 AM",
  },
];
      ...
      <Col sm="12">
        <Card>
          <Card.Header className="bg-light">
            <h4 className="mb-0">Sponsors List</h4>
          </Card.Header>
          <Card.Body>
            <div className="mb-3">
              <Link
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th style={headerStyle}>Sponsor Name</th>
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
              <span>
                Showing 1 to {sponsors.length} of {sponsors.length} entries
              </span>
              <nav>
