              ...
              <ul id="top-tab-list" className="p-0 row list-inline">
                ...
                >
                  <Link to="#">
                    ...
                    <span className="dark-wizard">Account</span>
                  </Link>
                </li>
                <li
                  id="personal"
                ...
                >
                  <Link to="#">
                    ...
                    <span className="dark-wizard">Personal</span>
                  </Link>
                </li>
                <li
                  id="payment"
                ...
                >
                  <Link to="#">
                    ...
                    <span className="dark-wizard">Image</span>
                  </Link>
                </li>
                <li
                  id="confirm"
              ...
              <fieldset className={`${show === "A" ? "d-block" : "d-none"}`}>
                <div className="form-card text-start">
                  <div className="row">
                    ...
                    <div className="col-5">
                      <h2 className="steps text-end fs-5">Step 1 - 4</h2>
                    </div>
                  </div>
                  <div className="row">
              ...
              >
                <div className="form-card text-start">
                  <div className="row">
                    ...
                    <div className="col-5">
                      <h2 className="steps text-end fs-5">Step 2 - 4</h2>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-6">
              ...
              >
                <div className="form-card text-start">
                  <div className="row">
                    ...
                    <div className="col-5">
                      <h2 className="steps text-end fs-5">Step 3 - 4</h2>
                    </div>
                  </div>
                  <div className="form-group">
              ...
              >
                <div className="form-card">
                  <Row>
                    ...
                    <div className="col-5">
                      <h2 className="steps text-end fs-5">Step 4 - 4</h2>
                    </div>
                  </Row>
                  <br />
                  <br />
