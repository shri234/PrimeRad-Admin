...
const Header = memo((props) => {
  ...
  const minisidebar = () => {
    document.getElementsByTagName("ASIDE")[0].classList.toggle("header-mini");
  };

  let location = useLocation();
  //optimized code
  const route = DashboardRouter.slice(0)
    ...
    <Navbar expand="xl" className="nav iq-navbar header-hover-menu left-border">
      <Container fluid className="navbar-inner">
        <Link to="/" className="navbar-brand">
          {/* <Logo color={true} /> */}
          <h4 className="logo-title d-none d-sm-block">PrimeRad Admin</h4>
        </Link>
        <div
