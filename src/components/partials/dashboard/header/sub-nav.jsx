...
import img2 from "/assets/images/user/01.jpg";
import img3 from "/assets/images/user/01.jpg";
import img4 from "/assets/images/user/01.jpg";
import avatar1 from "/assets/images/user/01.jpg";
import avatar2 from "/assets/images/user/01.jpg";
import avatar3 from "/assets/images/user/01.jpg";
import avatar4 from "/assets/images/user/01.jpg";
import avatar_1 from "/assets/images/user/01.jpg";
    ...
    <Fragment>
      ...
      >
        <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
          <Dropdown className="nav-item me-0 me-xl-0 pt-1 me-2  ">
                ...
                <Card.Body className="p-0 all-notification">
                  <div className="iq-sub-card">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3 flex-grow-1">
                        <h6 className="mb-0 ">{t("header.paige_turner")}</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <p className="mb-0">{t("header.paige")}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="iq-sub-card">
                    <div className="d-flex align-items-center">
                      ...
                      />
                      <div className="ms-3 flex-grow-1">
                        <h6 className="mb-0 ">{t("header.monty_carlo")}</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <p className="mb-0">{t("header.carlo_m")}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="iq-sub-card">
                    <div className="d-flex align-items-center">
                      ...
                      />
                      <div className="ms-3 flex-grow-1">
                        <h6 className="mb-0 ">{t("header.paul_molive")}</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <p className="mb-0">{t("header.paul")}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Dropdown as="li" className="nav-item theme-scheme-dropdown">
            ...
            >
              ...
              >
                ...
                <h6 className="ms-3 mb-0">{t("header.light")}</h6>
              </Dropdown.Item>
              <Dropdown.Item
                to="#"
                className="dropdown-item d-flex align-items-center"
              ...
              >
                ...
                <h6 className="ms-3 mb-0">{t("header.dard")}</h6>
              </Dropdown.Item>
              <Dropdown.Item
                to="#"
                className="dropdown-item d-flex align-items-center"
              ...
              >
                ...
                <h6 className="ms-3 mb-0">{t("header.auto")}</h6>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          ...
          <Dropdown as="li" className="nav-item iq-tour ps-3 ps-lg-0">
            ...
            <Dropdown.Menu variant="end">
              ...
              <Dropdown.Item to="/auth/sign-in" className="sub-drop-item">
                {t("header.logout")}
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
